  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-4">
        <h3 className="text-lg font-bold text-gray-900 dark:text-white line-clamp-1 transition-all duration-200 group-hover:text-primary-700 dark:group-hover:text-primary-300 flex-1 mr-2">
          {note.title}
        </h3>
        <button
          onClick={handleFavoriteClick}
          className={`p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 transform hover:scale-110 active:scale-95 flex-shrink-0 ${
            note.isFavorite 
